...
## Original Warfront grand-castle composition

The 501-block castle plans generated by `tools/gen-base-plans.js` are original Warfront
layouts released under LGPL-3.0-or-later. They combine the credited Repurposed
Structures rooms above with original walls, gothic halls, towers, courtyards, roads,
farms, villages, secret chambers, and furnishing. No downloadable castle map or
Hogwarts build is copied. The architectural reference is the general concentric-castle
and collegiate-gothic vocabulary; the block-by-block plans are generated here.
